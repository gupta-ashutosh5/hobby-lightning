...
/**
 * Provides a form for reverting a User quiz score revision.
 *
 * @ingroup upsc_quiz
 */
class UserQuizScoreRevisionRevertForm extends ConfirmFormBase {
  ...
  public function getFormId() {
    return 'user_quiz_score_revision_revert_confirm';
  }
   ...
   *
   * @param \Drupal\upsc_quiz\Entity\UserQuizScoreInterface $revision
